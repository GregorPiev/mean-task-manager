...
export class AuthenticationService {
  ...
  authenticate(username: string, password: string): Observable<any> {
    ...
    sendHeaders.append('Access-Control-Allow-Origin', 'http://localhost:3000');
    sendHeaders.append('Access-Control-Allow-Credentials', 'true');
    sendHeaders.append('Access-Control-Allow-Methods', 'GET, POST, PATCH, DELETE, PUT, OPTIONS');
    ...
    return this.http.get(url, { headers: sendHeaders });
  }
}
