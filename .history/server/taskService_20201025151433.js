            ...
            function (result) {
                ...
                if (result.length == 0) {
                    ...
                    for (var x = 0; x < result.length; x++) {
                        console.log('Current item:', result[x])
                        result[x].dateCreated = dateFormatter(result[x].dateCreated, 'mm/dd/yyyy');
                        if (result[x].dateCreated) {
                            result[x].dateCompleted = dateFormatter(result[x].dateCompleted, 'mm/dd/yyyy');
                        } else {
                        ...
                        if (result[x].dateScheduled) {
                            ...
                            result[x].dateScheduled = dateFormatter(result[x].dateScheduled, 'mm/dd/yyyy');
                        } else {
